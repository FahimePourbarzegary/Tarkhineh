...
function InfoPopupProduct({ setIsOpenInfo }: ProductCardMenuProps) {
  return (
    <div className="flex justify-center items-center  fixed top-0 left-0 w-full h-screen z-40 ">
      ...
      <div className="relative">
        {" "}
        <div className=" flex justify-center items-center   top-0 left-0 w-full h-screen  ">
          <div className=" md:w-[820px] md:h-auto bg-white rounded-lg ">
