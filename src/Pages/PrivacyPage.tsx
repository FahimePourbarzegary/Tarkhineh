...
import banner from "../assets/banner/privacy.jpg";
function PrivacyPage() {
  const QuestionsData = [
    ...
    },
    {
      ...
      answer:
        "از شما تقاضا خواهیم کرد اطلاعات خود را در اختیار ما قرار دهید؛ هنگامی‌که:به‌شکل کاربر مهمان غذا سفارش می‌دهید.\n  در وب‌سایت ترخینه یک حساب کاربری ایجاد می‌کنید.\n      در قسمت اعطای نمایندگی، فرم پر می‌کنید.",
    },
    {
